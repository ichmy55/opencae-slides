...
v14 = newv;  BooleanDifference(v14) = {Volume{v13}; Delete;}{Volume{v11};};
//
// 球殻（右下部）を切り出す
//
v15 = newv;  BooleanDifference(v15) = {Volume{v6}; }{Volume{v2};Delete;};
v16 = newv;  BooleanDifference(v16) = {Volume{v15}; Delete;}{Volume{v12};};
//
// 球殻（上部）を切り出す
//
